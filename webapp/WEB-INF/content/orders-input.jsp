...
<head>
	...
	<script type="text/javascript">
		$(function() {
			...
			$( "#orderDate" ).datepicker( $.datepicker.regional[ "zh-CN" ] );
			$( "#deliverDate" ).datepicker( $.datepicker.regional[ "zh-CN" ] );
		});
	</script>
</head>
...
<div id="bd">
	<div id="yui-main">
	<div class="yui-b">
	<h2><s:if test="id == null">创建</s:if><s:else>修改</s:else>订单信息</h2>
	<form id="inputForm" action="orders!save.action" method="post">
		...
		<table class="noborder">
			...
			<tr>
				<td>订单日期:<input type="text" id="orderDate" name="orderDate" size="30" value="${orderDate}"/></td>
				<td>发货日期:<input type="text" id="deliverDate" name="deliverDate" size="30" value="${deliverDate}"/></td>
			</tr>
			<tr>
				<td colspan="2">数量:<input type="text" id="number" name="number" size="30" value="${number}"/></td>
			</tr>
			<tr>
				<td colspan="2">
