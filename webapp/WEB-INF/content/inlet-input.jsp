...
<head>
	...
	<script type="text/javascript">
		$(function() {
			...
			$( "#inletDate" ).datepicker( $.datepicker.regional[ "zh-CN" ] );
		});
	</script>
</head>
...
<div id="bd">
	<div id="yui-main">
	<div class="yui-b">
	<h2><s:if test="id == null">创建</s:if><s:else>修改</s:else>进货信息</h2>
	<form id="inputForm" action="inlet!save.action" method="post">
		<input type="hidden" name="id" value="${id}"/>
		<table class="noborder">
			<tr>
				<td>商品名称:<input type="text" name="product" id="product" size="50" value="${productName}"/>
			...
			<tr>
				<td>进货日期:<input type="text" id="inletDate" name="inletDate" size="30" value="${inletDate}"/></td>
			</tr>
			<tr>
