...
<div id="bd" align="center">
	<div id="yui-main">
	<div class="yui-b">
	<form id="mainForm" action="supply.action" method="get">
		<div id="filter">
			<security:authorize ifAnyGranted="A_MODIFY_USER">
	 			<a href="supply!input.action">增加新供应商</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	 		</security:authorize>
	 		<input type="text" name="filter_LIKES_name" value="${param['filter_LIKES_name']}"  size="10"/> 
			<input type="button" value="按供应名搜索" onclick="search()"/>
		</div>
					...
					<tr>
						...
						<td>&nbsp;
							...
							<security:authorize ifNotGranted="A_MODIFY_USER">
								<a href="supply!input.action?id=${id}">查看</a>&nbsp;
							</security:authorize>
							</security:authorize>
							<security:authorize ifAnyGranted="A_MODIFY_USER">
							<a href="supply!input.action?id=${id}">修改</a>&nbsp;
							<a href="supply!delete.action?id=${id}">删除</a>
							</security:authorize>
						</td>
					</tr>
				</s:iterator>
