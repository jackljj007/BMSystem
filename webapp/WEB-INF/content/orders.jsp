...
<div id="bd" align="center">
	<div id="yui-main">
	<div class="yui-b">
	<form id="mainForm" action="orders.action" method="get">
		...
		<div id="content">
			<table id="contentTable">
				<tr>
					<td colspan="6">
						<a href="orders!input.action">新增订单</a>
					</td>
				</tr>
				<tr>
					<th>商品名称</th>
				...
				<s:iterator value="page.result">
					<tr>
						...
						<td>&nbsp;
							<s:if test="state == 0">
								<a href="orders!input.action?id=${id}">修改</a>&nbsp;
								<a href="orders!delete.action?id=${id}">删除</a>&nbsp;
								<a href="orders!deliver.action?id=${id}" onclick="deliver();">发货</a>
							</s:if>
							<s:else>已发货</s:else>
						</td>
					</tr>
