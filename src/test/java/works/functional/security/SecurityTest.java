package works.functional.security;

import org.junit.Test;
import works.functional.BaseSeleniumTestCase;
...
public class SecurityTest extends BaseSeleniumTestCase {
	...
	public void checkAnonymous() {
		//访问退出登录页面,退出之前的登录
		selenium.open("/BMSystem/j_spring_security_logout");
		assertTrue(selenium.isElementPresent("//input[@value='登录']"));

		//访问任意页面会跳转到登录界面
		selenium.open("/BMSystem/security/user.action");
		assertTrue(selenium.isElementPresent("//input[@value='登录']"));
	}
